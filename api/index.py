...
@app.route('/')
def home():
    """Serve the main HTML file embedded directly"""
...
<body>
    ...
    <script>
        ...
        function createChart(elementId, candleData, ranges, timeframe) {
            ...
            const layout = {
                title: `MNQ Futures - ${timeframe.toUpperCase()} (${new Date(date).toLocaleDateString('en-US', {month: 'short', day: 'numeric', year: 'numeric'})} PT)`,
